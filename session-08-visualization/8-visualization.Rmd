...
```{r}
advanced_scatter <- ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species, shape = species)) +
  geom_point() +
  labs(
...
2. Set a fill color using fill = "red" or a hex code such as "#FF6666".

3. Experiment with different geoms by replacing geom_histogram() with options like geom_density(), geom_bar(), or others.
...
```{r}
box <- ggplot(penguins, aes(x = species, y = body_mass_g)) +
  geom_boxplot(fill = "brown") +
  theme_minimal() +
  coord_flip()
box

violin <- ggplot(penguins, aes(x = species, y = body_mass_g)) +
  geom_violin(fill = "brown", trim = F) +
  theme_minimal() +
  coord_flip()
violin
```
...
ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
  geom_point() +
  geom_smooth(method = "lm", inherit.aes = F, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
